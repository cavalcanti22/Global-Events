...
<head>
	...
	<title>Painel - Global Events 1959</title>
	...
	<link href="<?=site_url()?>resources/admin/assets/css/colors.css" rel="stylesheet" type="text/css">
	 <link rel="stylesheet" type="text/css" href="<?=site_url()?>resources/admin/assets/css/estilos.css">
	<!-- /global stylesheets -->
...
<body>
	...
	<div class="navbar navbar-inverse">
		<div class="navbar-header">
			<a class="navbar-brand" href="<?=site_url()."Usuarios/index"?>">Global Events 1959</a>
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown dropdown-user">
					<a class="dropdown-toggle" data-toggle="dropdown">
						<img src="<?=site_url()?>resources/site/assets/img/globalvideo.png" alt="">
	...
	<div class="page-container">
				...
				<div class="sidebar-content">
					...
					<div class="sidebar-user">
						<div class="category-content">
							<div class="media">
								<a href="" class="media-left"><img src="<?=site_url()?>resources/site/assets/img/globalvideo.png" class="img-circle img-sm" alt=""></a>
								<div class="media-body">
									<span class="media-heading text-semibold"><?=$_SESSION['user']['nome'];?></span>
									<div class="text-size-mini text-muted">
										<i class="icon-pin text-size-small"></i> &nbsp;Itacaré - BA
									</div>
								</div>
							</div>
						</div>
					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									<a href="<?=site_url()."Paginas/index"?>"><i class="icon-stack2"></i> <span>Páginas</span></a>

								</li>
									<li>
									<a href="<?=site_url()."Portifolios/index"?>"><i class="icon-copy"></i> <span>Eventos</span></a>

								</li>
									<li>
									<a href="<?=site_url()."Parceiros/index"?>"><i class="icon-thumbs-up2"></i> <span>Parceiros</span></a>
		...
		<!-- Page header -->
					...
					<div class="page-header-content">
						...
						<div class="heading-elements">
							<div class="heading-btn-group">
								...
								<a href="<?=site_url()?>Portifolios/add" class="btn btn-link btn-float has-text"><i class="icon-copy"></i> <span>Add Evento</span></a>
								<a href="<?=site_url()?>Parceiros/add" class="btn btn-link btn-float has-text"><i class="icon-thumbs-up2"></i> <span>Add Parceiros</span></a>
							</div>
				...
				<!-- Content area -->
				<div class="cpage-header page-header-default">
					<div class="page-header-content">
